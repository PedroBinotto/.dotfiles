...
_G.packer_plugins = {
  ...
  ["exrc.nvim"] = {
    loaded = true,
    path = "/home/pedro/.local/share/nvim/site/pack/packer/start/exrc.nvim",
  ...
  ["onedark.vim"] = {
    loaded = true,
    path = "/home/pedro/.local/share/nvim/site/pack/packer/start/onedark.vim",
    url = "https://github.com/joshdick/onedark.vim"
  },
  ["onedarkpaco.vim"] = {
    loaded = true,
    path = "/home/pedro/.local/share/nvim/site/pack/packer/start/onedarkpaco.vim",
    url = "https://github.com/pacokwon/onedarkpaco.vim"
  },
  ["packer.nvim"] = {
    loaded = true,
  ...
  ["vim-one"] = {
    loaded = true,
    path = "/home/pedro/.local/share/nvim/site/pack/packer/start/vim-one",
